...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const BATTLE_ANIM_OBJ_DRAIN_KISS_CENTER   ; 3e
	const BATTLE_ANIM_OBJ_GUST                ; 3f
	const BATTLE_ANIM_OBJ_VINE_WHIP1          ; 40
	const BATTLE_ANIM_OBJ_VINE_WHIP2          ; 41
	const BATTLE_ANIM_OBJ_RAZOR_WIND1         ; 42
	const BATTLE_ANIM_OBJ_RAZOR_WIND2         ; 43
	const BATTLE_ANIM_OBJ_SONICBOOM_JP        ; 44
	const BATTLE_ANIM_OBJ_WARP                ; 45
	const BATTLE_ANIM_OBJ_ABSORB              ; 46
	const BATTLE_ANIM_OBJ_DRAIN_KISS          ; 47
	const BATTLE_ANIM_OBJ_EGG                 ; 48
	const BATTLE_ANIM_OBJ_FOCUS               ; 49
	const BATTLE_ANIM_OBJ_BIND1               ; 4a
	const BATTLE_ANIM_OBJ_BIND2               ; 4b
	const BATTLE_ANIM_OBJ_LEECH_SEED          ; 4c
	const BATTLE_ANIM_OBJ_SOUND               ; 4d
	const BATTLE_ANIM_OBJ_WAVE                ; 4e
	const BATTLE_ANIM_OBJ_CONFUSE_RAY         ; 4f
	const BATTLE_ANIM_OBJ_LEER                ; 50
	const BATTLE_ANIM_OBJ_LEER_TIP            ; 51
	const BATTLE_ANIM_OBJ_SCREEN              ; 52
	const BATTLE_ANIM_OBJ_HARDEN              ; 53
	const BATTLE_ANIM_OBJ_CHICK               ; 54
	const BATTLE_ANIM_OBJ_AMNESIA             ; 55
	const BATTLE_ANIM_OBJ_ASLEEP              ; 56
	const BATTLE_ANIM_OBJ_SKULL               ; 57
	const BATTLE_ANIM_OBJ_DIG_SAND            ; 58
	const BATTLE_ANIM_OBJ_DIG_PILE            ; 59
	const BATTLE_ANIM_OBJ_SAND                ; 5a
	const BATTLE_ANIM_OBJ_PARALYZED           ; 5b
	const BATTLE_ANIM_OBJ_STRING_SHOT         ; 5c
	const BATTLE_ANIM_OBJ_HAZE                ; 5d
	const BATTLE_ANIM_OBJ_MIST                ; 5e
	const BATTLE_ANIM_OBJ_SMOG                ; 5f
	const BATTLE_ANIM_OBJ_POISON_GAS          ; 60
	const BATTLE_ANIM_OBJ_HORN                ; 61
	const BATTLE_ANIM_OBJ_NEEDLE              ; 62
	const BATTLE_ANIM_OBJ_PETAL_DANCE         ; 63
	const BATTLE_ANIM_OBJ_SLUDGE_BOMB         ; 64
	const BATTLE_ANIM_OBJ_PAY_DAY             ; 65
	const BATTLE_ANIM_OBJ_SONICBOOM_JP_UNUSED ; 66
	const BATTLE_ANIM_OBJ_MIMIC               ; 67
	const BATTLE_ANIM_OBJ_ATTRACT             ; 68
	const BATTLE_ANIM_OBJ_BONEMERANG          ; 69
	const BATTLE_ANIM_OBJ_BONE_CLUB           ; 6a
	const BATTLE_ANIM_OBJ_BONE_RUSH           ; 6b
	const BATTLE_ANIM_OBJ_SWIFT               ; 6c
	const BATTLE_ANIM_OBJ_KINESIS             ; 6d
	const BATTLE_ANIM_OBJ_FLASH               ; 6e
	const BATTLE_ANIM_OBJ_SHINY               ; 6f
	const BATTLE_ANIM_OBJ_SKY_ATTACK          ; 70
	const BATTLE_ANIM_OBJ_LICK                ; 71
	const BATTLE_ANIM_OBJ_WITHDRAW            ; 72
	const BATTLE_ANIM_OBJ_DRAIN               ; 73
	const BATTLE_ANIM_OBJ_GROWTH              ; 74
	const BATTLE_ANIM_OBJ_CONVERSION2         ; 75
	const BATTLE_ANIM_OBJ_SMOKE               ; 76
	const BATTLE_ANIM_OBJ_SMOKESCREEN         ; 77
	const BATTLE_ANIM_OBJ_SWORDS_DANCE        ; 78
	const BATTLE_ANIM_OBJ_SPEED_LINE          ; 79
	const BATTLE_ANIM_OBJ_SHARPEN             ; 7a
	const BATTLE_ANIM_OBJ_DEFENSE_CURL        ; 7b
	const BATTLE_ANIM_OBJ_METRONOME_HAND      ; 7c
	const BATTLE_ANIM_OBJ_METRONOME_SPARKLE   ; 7d
	const BATTLE_ANIM_OBJ_DISABLE             ; 7e
	const BATTLE_ANIM_OBJ_AGILITY             ; 7f
	const BATTLE_ANIM_OBJ_HEART               ; 80
	const BATTLE_ANIM_OBJ_FLAME_WHEEL         ; 81
	const BATTLE_ANIM_OBJ_SACRED_FIRE         ; 82
	const BATTLE_ANIM_OBJ_COTTON_SPORE        ; 83
	const BATTLE_ANIM_OBJ_MILK_DRINK          ; 84
	const BATTLE_ANIM_OBJ_ANGER               ; 85
	const BATTLE_ANIM_OBJ_HEAL_BELL           ; 86
	const BATTLE_ANIM_OBJ_HEAL_BELL_NOTE      ; 87
	const BATTLE_ANIM_OBJ_BATON_PASS          ; 88
	const BATTLE_ANIM_OBJ_LOCK_ON             ; 89
	const BATTLE_ANIM_OBJ_MIND_READER         ; 8a
	const BATTLE_ANIM_OBJ_SAFEGUARD           ; 8b
	const BATTLE_ANIM_OBJ_PROTECT             ; 8c
	const BATTLE_ANIM_OBJ_THIEF               ; 8d
	const BATTLE_ANIM_OBJ_MUDSHOT             ; 8e
	const BATTLE_ANIM_OBJ_PRESENT             ; 8f
	const BATTLE_ANIM_OBJ_SPIKES              ; 90
	const BATTLE_ANIM_OBJ_POWDER_SNOW         ; 91
	const BATTLE_ANIM_OBJ_DRAGONBREATH        ; 92
	const BATTLE_ANIM_OBJ_CONVERSION          ; 93
	const BATTLE_ANIM_OBJ_SPIDER_WEB          ; 94
	const BATTLE_ANIM_OBJ_CAKE_UNUSED         ; 95
	const BATTLE_ANIM_OBJ_NIGHTMARE           ; 96
	const BATTLE_ANIM_OBJ_IN_NIGHTMARE        ; 97
	const BATTLE_ANIM_OBJ_WILL_O_WISP         ; 98
	const BATTLE_ANIM_OBJ_LOVELY_KISS         ; 99
	const BATTLE_ANIM_OBJ_SWEET_KISS          ; 9a
	const BATTLE_ANIM_OBJ_SKETCH              ; 9b
	const BATTLE_ANIM_OBJ_ENCORE_HAND         ; 9c
	const BATTLE_ANIM_OBJ_ENCORE_STAR         ; 9d
	const BATTLE_ANIM_OBJ_DESTINY_BOND        ; 9e
	const BATTLE_ANIM_OBJ_MORNING_SUN         ; 9f
	const BATTLE_ANIM_OBJ_GLIMMER             ; a0
	const BATTLE_ANIM_OBJ_MOONLIGHT           ; a1
	const BATTLE_ANIM_OBJ_HIDDEN_POWER        ; a2
	const BATTLE_ANIM_OBJ_CROSS_CHOP1         ; a3
	const BATTLE_ANIM_OBJ_CROSS_CHOP2         ; a4
	const BATTLE_ANIM_OBJ_SANDSTORM           ; a5
	const BATTLE_ANIM_OBJ_ZAP_CANNON          ; a6
	const BATTLE_ANIM_OBJ_SPITE               ; a7
	const BATTLE_ANIM_OBJ_CURSE               ; a8
	const BATTLE_ANIM_OBJ_PERISH_SONG         ; a9
	const BATTLE_ANIM_OBJ_FORESIGHT           ; aa
	const BATTLE_ANIM_OBJ_RAPID_SPIN          ; ab
	const BATTLE_ANIM_OBJ_SWAGGER             ; ac
	const BATTLE_ANIM_OBJ_BELLY_DRUM_HAND     ; ad
	const BATTLE_ANIM_OBJ_BELLY_DRUM_NOTE     ; ae
	const BATTLE_ANIM_OBJ_MEAN_LOOK           ; af
	const BATTLE_ANIM_OBJ_BETA_PURSUIT        ; b0
	const BATTLE_ANIM_OBJ_SHOOTING_SPARKLE    ; b1
	const BATTLE_ANIM_OBJ_RAIN                ; b2
	const BATTLE_ANIM_OBJ_B0                  ; b3
	const BATTLE_ANIM_OBJ_PSYCH_UP            ; b4
	const BATTLE_ANIM_OBJ_ANCIENTPOWER        ; b5
	const BATTLE_ANIM_OBJ_AEROBLAST           ; b6
	const BATTLE_ANIM_OBJ_SHADOW_BALL         ; b7
	const BATTLE_ANIM_OBJ_ROCK_SMASH          ; b8
	const BATTLE_ANIM_OBJ_FLOWER              ; b9
	const BATTLE_ANIM_OBJ_COTTON              ; ba
	const BATTLE_ANIM_OBJ_ENEMYFEET_1ROW      ; bb
	const BATTLE_ANIM_OBJ_PLAYERHEAD_1ROW     ; bc
	const BATTLE_ANIM_OBJ_ENEMYFEET_2ROW      ; bd
	const BATTLE_ANIM_OBJ_PLAYERHEAD_2ROW     ; be
	const BATTLE_ANIM_OBJ_DRAGON_DANCE        ; bf
	const BATTLE_ANIM_OBJ_HAIL                ; c0
...
; BattleAnimOAMData indexes (see data/battle_anims/oam.asm)
	...
	const BATTLE_ANIM_OAMSET_HAIL ; d8
