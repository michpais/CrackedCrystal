...
; - BattleAnimations (see data/moves/animations.asm)
	...
	const FIRE_BLAST   ; 7e
	const WATERFALL    ; 7f
	const EARTH_POWER  ; 80
	const SWIFT        ; 81
	const EXTRASENSORY ; 82
	const DRAGON_DANCE ; 83
	const PAYBACK      ; 84
	const AMNESIA      ; 85
	const KINESIS      ; 86
	const IRON_DEFENSE ; 87
	...
	const GIGA_IMPACT  ; 8f
	const TRANSFORM    ; 90
	const BUBBLE       ; 91
	const DIZZY_PUNCH  ; 92
	const SPORE        ; 93
	const FLASH        ; 94
	const WILL_O_WISP  ; 95
	const SPLASH       ; 96
	const ACID_ARMOR   ; 97
	const CRABHAMMER   ; 98
	const EXPLOSION    ; 99
	const FURY_SWIPES  ; 9a
	const ZEN_HEADBUTT ; 9b
	const REST         ; 9c
	const ROCK_SLIDE   ; 9d
	const HYPER_FANG   ; 9e
	const AQUA_TAIL    ; 9f
	...
	const STRUGGLE     ; a5
	const SKETCH       ; a6
	const NIGHT_SLASH  ; a7
	const THIEF        ; a8
	const POISON_JAB   ; a9
	const MIND_READER  ; aa
	const SHADOW_CLAW  ; ab
