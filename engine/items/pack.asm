; Pack.Jumptable and BattlePack.Jumptable indexes
	...
	const PACKSTATE_INITMEDICINEPOCKET ; doesn't need to be in order
	const PACKSTATE_MEDICINEPOCKETMENU ; doesn't need to be in order
...
.MedicinePocketMenu:
	...
	call CopyMenuHeader
	ld a, [wMedsPocketCursor]
	ld [wMenuCursorPosition], a
	ld a, [wMedsPocketScrollPosition]
	ld [wMenuScrollPosition], a
	call ScrollingMenu
	ld a, [wMenuScrollPosition]
	ld [wMedsPocketScrollPosition], a
	ld a, [wMenuCursorY]
	ld [wMedsPocketCursor], a
