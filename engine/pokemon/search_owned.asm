...
; BUG (FIXED): CheckOwnMon does not check the Day-Care (see docs/bugs_and_glitches.md)
...
; BUG (FIXED): CheckOwnMon only checks the first five letters of OT names (see docs/bugs_and_glitches.md)
