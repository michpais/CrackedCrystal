...
MountMortar2FInsideTMDarkPulse:
...
MountMortar2FInside_MapEvents:
	...
	object_event 19, 17, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar2FInsideTMDarkPulse, EVENT_MOUNT_MORTAR_2F_INSIDE_TM_DARK_PULSE
