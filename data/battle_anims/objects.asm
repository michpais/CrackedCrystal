...
; ANIM_OBJ_DRAIN_KISS_CENTER
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_44, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_GUST
...
; ANIM_OBJ_DRAIN_KISS
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_4C, BATTLEANIMFUNC_ABSORB, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE
; ANIM_OBJ_EGG
...
; ANIM_OBJ_MUDSHOT
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_GRAY, ANIM_GFX_SAND
; ANIM_OBJ_PRESENT
...
; ANIM_OBJ_WILL_O_WISP
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_PRESENT_SMOKESCREEN, PAL_BATTLE_OB_RED, ANIM_GFX_EGG
...
; ANIM_OBJ_DRAGON_DANCE
	battleanimobj RELATIVE_X | X_FLIP, $68, BATTLEANIMFRAMESET_89, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_RED, ANIM_GFX_MISC
; ANIM_OBJ_HAIL
