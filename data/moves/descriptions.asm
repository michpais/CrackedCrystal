...
DarkPulseDescription:
	db   "A dark aura pulse,"
	next "target may flinch@"
...
DragonPulseDescription:
	db   "Fierce shock wave"
	next "from user's mouth@"
