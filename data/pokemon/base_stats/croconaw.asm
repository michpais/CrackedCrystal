	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROAR, TOXIC, ROCK_SMASH, HIDDEN_POWER, SNORE, BLIZZARD, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, IRON_TAIL, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, DETECT, REST, ATTRACT, FURY_CUTTER, ICE_BEAM, AVALANCHE, SHADOW_CLAW, DRAGON_CLAW, AERIAL_ACE, HAIL, WATER_PULSE, CUT, SURF, STRENGTH, WHIRLPOOL, ICE_BEAM
	; end
