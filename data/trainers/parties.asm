...
WillGroup:
	...
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, LEAF_BLADE, PSYCHIC_M
...
BrunoGroup:
	...
	db 43, ONIX,       WRAP, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
...
KarenGroup:
	...
	db 42, VILEPLUME,  STUN_SPORE, ACID, SYNTHESIS, PETAL_DANCE
	db 45, GENGAR,     LICK, SPITE, CURSE, DESTINY_BOND
	db 44, MURKROW,    QUICK_ATTACK, AERIAL_ACE, PURSUIT, FAINT_ATTACK
...
KogaGroup:
	...
	db 40, ARIADOS,    DOUBLE_TEAM, PIN_MISSILE, BATON_PASS, GIGA_DRAIN
...
BrockGroup:
	...
	db 41, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, ROCK_BLAST
	db 42, OMASTAR,    BITE, SURF, PROTECT, ANCIENTPOWER
	db 44, ONIX,       WRAP, ROCK_SLIDE, BIDE, SANDSTORM
...
MistyGroup:
	...
	db 42, GOLDUCK,    SURF, DISABLE, CALM_MIND, PSYCHIC_M
...
LtSurgeGroup:
	...
	db 40, MAGNETON,   FLASH_CANNON, THUNDER_WAVE, SWIFT, THUNDERBOLT
	db 40, ELECTRODE,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
...
ScientistGroup:
	...
	db 30, PORYGON,    CONVERSION, ZEN_HEADBUTT, RECOVER, TRI_ATTACK
	db -1 ; end
...
SchoolboyGroup:
	...
	db 37, VILEPLUME,  SOLARBEAM, SLEEP_POWDER, ACID, SYNTHESIS
	db -1 ; end
	...
	db 38, MAGNETON,   FLASH_CANNON, THUNDER_WAVE, SWIFT, THUNDERBOLT
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 38, PIDGEOT,    TOXIC, QUICK_ATTACK, AERIAL_ACE, FLY
	db 38, PIDGEOT,    AERIAL_ACE, DETECT, STEEL_WING, FLY
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, WATERFALL, PROTECT
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, WATERFALL, BLIZZARD
	db 39, FLAREON,    NO_ITEM,      FLAMETHROWER, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (8)
	db "RYAN@", TRAINERTYPE_MOVES
	db 25, PIDGEOT,    SAND_ATTACK, QUICK_ATTACK, AERIAL_ACE, STEEL_WING
	...
	db 35, GOLDUCK,    CONFUSION, SCREECH, CALM_MIND, FURY_SWIPES
	db -1 ; end

	; COOLTRAINERM (10)
	db "GAVEN@", TRAINERTYPE_MOVES
	db 32, VICTREEBEL, WRAP, TOXIC, ACID, RAZOR_LEAF
	db 32, KINGLER,    BUBBLEBEAM, STOMP, WATERFALL, PROTECT
	...
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_RAGE, BODY_SLAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, BUTTERFREE, PSYBEAM, SLEEP_POWDER, AERIAL_ACE, GUST
...
PokemaniacGroup:
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, PSYCHIC_M, RECOVER
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, MR__MIME,   LIGHT_SCREEN, REFLECT, BATON_PASS, PSYCHIC_M
...
BugCatcherGroup:
	...
	db 24, BUTTERFREE, PSYBEAM, POISONPOWDER, SUPERSONIC, AERIAL_ACE
	db 24, BUTTERFREE, PSYBEAM, STUN_SPORE, SUPERSONIC, AERIAL_ACE
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, ACID, TOXIC
	db 24, BUTTERFREE, PSYBEAM, SLEEP_POWDER, SUPERSONIC, AERIAL_ACE
	db -1 ; end
	...
	db 32, BEEDRILL,   PIN_MISSILE, DOUBLE_TEAM, ACID, TOXIC
	db 34, BUTTERFREE, PSYBEAM, SLEEP_POWDER, SUPERSONIC, AIR_SLASH
	db -1 ; end
...
FisherGroup:
	...
	db 25, REMORAID,   MEAN_LOOK, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 25, REMORAID,   MEAN_LOOK, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, MEDITATE, MEGA_KICK, FOCUS_ENERGY
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33, KOFFING,    TACKLE, SLUDGE, SMOKESCREEN, POISON_GAS
...
PicnickerGroup:
	...
	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 43, CLEFAIRY,   METRONOME, ENCORE, RECOVER, MINIMIZE
	db -1 ; end
...
CamperGroup:
	...
	db 34, GOLDUCK,    DISABLE, PSYCHIC_M, SURF, CALM_MIND
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 32, MURKROW,    WING_ATTACK, DARK_PULSE, PAYBACK, NIGHT_SHADE
	db -1 ; end
	...
	db 25, MURKROW,    WING_ATTACK, DARK_PULSE, PAYBACK, NIGHT_SHADE
	db -1 ; end
...
BlueGroup:
	...
	db 56, PIDGEOT,    QUICK_ATTACK, AERIAL_ACE, RECOVER, MIRROR_MOVE
	...
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, LEAF_BLADE, SOLARBEAM
